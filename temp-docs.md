THIS IS THE UI FOR SIGNUP-LOGIN FORM FOR AOUR AUTHENTICATIO
APPLY ONLY THE UI, NEVER COMPENSATE WITH OUR LOGIC, FUNCTION,ETC.
JUST APPLY UI,IN EXCAHNGE OF OLD SIGNUP FORM WITH THIS ONW WITHOUT LOSING ALL THE MAIN FEATURES LIKE M
AUTOMATIC EMAIL,GOOGLE,GITHUB,ETC.  ONLY UPDATE UI FRONTEND.
