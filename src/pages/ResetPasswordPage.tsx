  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (userId && secret) {
        ...
        console.log('🔍 Using direct Appwrite account.updateRecovery');

        // Import Appwrite directly to bypass any service layer issues
        ...
        console.log('🔍 Using resetPassword from AuthContext');
